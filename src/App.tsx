          ...
          <div className="row nav__row">
            ...
            <ul className="nav__list">
              <li className="nav__link">
                <a className="nav__link--anchor" href="#quality-work"> About </a>
              ...
              <li className="nav__link">
                <a className="nav__link--anchor" href="#pricing"> Pricing </a>
                <div className="nav__link--underline"></div>
              </li>
              <li className="nav__link">
            ...
            <div className="menu__backdrop">
              ...
              <ul className="menu__links">
                <li className="menu__list">
                  <a href="#quality-work" className="menu__list--link" onClick={closeMenu}>About</a>
                </li>
                <li className="menu__list">
                  <a className="menu__list--link not-working">Blog</a>
                </li>
                <li className="menu__list">
                  <a href="#pricing" className="menu__list--link" onClick={closeMenu}>Pricing</a>
                </li>
                <li className="menu__list">
                ...
                <li className="menu__list">
                  <a className="menu__list--link menu__link--primary not-working">Sign Up</a>
                </li>
              </ul>
            </div>
          </div>
